                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Text(
                                text = "Create a full data backup (database + attachments).",
                            ...
                            Row(
                                ...
                                Text(
                                    text = if (isBackupInProgress) "Creating backup..." else "Full backup",
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        backupLauncher.launch("lifepad-backup-$timeStamp.zip")
                                    },
